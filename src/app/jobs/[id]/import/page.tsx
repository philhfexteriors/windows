    ...
    return (
      <AppShell>
        <div className="max-w-2xl mx-auto text-center py-12">
          ...
          <p className="text-sm text-gray-500 mb-4">You don&apos;t have permission to import windows.</p>
          <Link href={`/jobs/${job.id}`} className="text-sm text-primary hover:underline">Back to Job</Link>
        </div>
      </AppShell>
    );
  }
